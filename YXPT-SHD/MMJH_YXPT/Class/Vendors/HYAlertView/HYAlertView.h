 ...
 *  显示弹出框
 */
-(void)showWithCompletion:(void (^)(HYAlertView *alertView ,NSInteger selectIndex,NSString *text))completeBlock;

-(void)showInView:(UIView *)baseView completion:(void (^)(HYAlertView *alertView ,NSInteger selectIndex,NSString *text))completeBlock;
