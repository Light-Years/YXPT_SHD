...
///正常字体
#define H40 [UIFont systemFontOfSize:40]
...
#define red_color       [UIColor colorWithRed:225/255.0 green:66/255.0 blue:88/255.0 alpha:1.0f]
...
#define DSColor(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1.0f]

#define  BlackTextColor  DSColor(51, 51, 51)
#define  darkGrayTextColor  DSColor(102, 102, 102)
#define  pinkTextColor DSColor(225, 66, 88)
#define lightGrayTextColor DSColor(153, 153, 153)

#define  BackGroundColor DSColor(250, 250, 250)
#define  lineBackGroundColor DSColor(238, 238, 238)
